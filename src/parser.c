...
enum {
  ...
  sym__integer_literal = 55,
  sym__string_literal = 56,
  sym_array_constructor = 57,
  sym_binary_expression = 58,
  sym_conditional_expression = 59,
  sym_object_constructor = 60,
  sym_parenthesized_expression = 61,
  sym_unary_expression = 62,
  sym__element = 63,
  sym_keyed_element = 64,
  sym_unkeyed_element = 65,
  aux_sym_array_constructor_repeat1 = 66,
};
